...
const Sidebar: React.FC = () => {
  const { sidebarOpen, toggleSidebar, isAuthenticated, user, logout, currency } = useShop();
      ...
      <div className="flex flex-col h-full p-4">
        <div className="flex items-center justify-between mb-8">
          <NavLink to="/" className="flex items-center space-x-2" onClick={handleCloseSidebar}>
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-gray-100">GameShop</span>
          </NavLink>
          <Button 
            variant="ghost" 
            size="icon" 
